...
<option value="Climate Modeling">Climate Modeling (81)</option>
<option value="Climate Policy">Climate Policy (1)</option>
<option value="Computer Vision">Computer Vision (88)</option>
<option value="Cryospheric Science">Cryospheric Science (1)</option>
<option value="Data Assimilation">Data Assimilation (1)</option>
<option value="Deep Learning">Deep Learning (129)</option>
...
<option value="Earth System Modeling">Earth System Modeling (25)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (24)</option>
...
<option value="Machine Learning">Machine Learning (152)</option>
