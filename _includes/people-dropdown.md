...
<option value="Biodiversity">Biodiversity (62)</option>
<option value="Bioinformatics">Bioinformatics (1)</option>
<option value="Causal AI">Causal AI (1)</option>
<option value="Climate Impacts">Climate Impacts (18)</option>
...
<option value="Earth Observation">Earth Observation (82)</option>
...
<option value="Machine Learning">Machine Learning (121)</option>
<option value="Machine Listening">Machine Listening (2)</option>
<option value="Marine Ecology">Marine Ecology (20)</option>
