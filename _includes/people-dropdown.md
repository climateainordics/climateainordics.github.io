...
<option value="Climate Impacts">Climate Impacts (32)</option>
<option value="Climate Modeling">Climate Modeling (74)</option>
<option value="Climate Policy">Climate Policy (1)</option>
<option value="Computer Vision">Computer Vision (86)</option>
<option value="Deep Learning">Deep Learning (121)</option>
