...
<option value="Biodiversity">Biodiversity (68)</option>
<option value="Bioinformatics">Bioinformatics (1)</option>
<option value="Causal AI">Causal AI (1)</option>
<option value="Climate Impacts">Climate Impacts (26)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (17)</option>
...
<option value="Machine Learning">Machine Learning (134)</option>
...
<option value="Sustainable Cities">Sustainable Cities (54)</option>
...
<option value="Urban Planning">Urban Planning (35)</option>
