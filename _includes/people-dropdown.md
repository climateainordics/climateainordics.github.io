...
<option value="AutoML">AutoML (27)</option>
...
<option value="Biodiversity">Biodiversity (103)</option>
...
<option value="Climate Impacts">Climate Impacts (99)</option>
<option value="Climate Modeling">Climate Modeling (127)</option>
<option value="Climate Policy">Climate Policy (1)</option>
<option value="Computer Vision">Computer Vision (125)</option>
...
<option value="Deep Learning">Deep Learning (187)</option>
...
<option value="Earth Observation">Earth Observation (157)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (64)</option>
...
<option value="Machine Learning">Machine Learning (220)</option>
...
<option value="NLP">NLP (50)</option>
