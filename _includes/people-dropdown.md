...
<option value="Climate Impacts">Climate Impacts (67)</option>
<option value="Climate Modeling">Climate Modeling (101)</option>
...
<option value="Deep Learning">Deep Learning (156)</option>
...
<option value="Earth System Modeling">Earth System Modeling (44)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (43)</option>
...
<option value="Machine Learning">Machine Learning (186)</option>
