...
<option value="Climate Impacts">Climate Impacts (5)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (1)</option>
...
<option value="Machine Learning">Machine Learning (105)</option>
