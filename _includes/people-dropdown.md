...
<option value="Deep Learning">Deep Learning (81)</option>
...
<option value="Machine Learning">Machine Learning (93)</option>
...
<option value="Sustainable Cities">Sustainable Cities (32)</option>
