...
<option value="Deep Learning">Deep Learning (168)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (140)</option>
<option value="Earth System Modeling">Earth System Modeling (54)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (53)</option>
...
<option value="Machine Learning">Machine Learning (203)</option>
<option value="Machine Listening">Machine Listening (2)</option>
<option value="Marine Ecology">Marine Ecology (30)</option>
...
<option value="Soundscape Analysis">Soundscape Analysis (27)</option>
