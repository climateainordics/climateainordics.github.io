...
<option value="Computer Vision">Computer Vision (109)</option>
...
<option value="Earth Observation">Earth Observation (132)</option>
<option value="Earth System Modeling">Earth System Modeling (50)</option>
...
<option value="Efficient or Sustainable AI">Efficient or Sustainable AI (90)</option>
...
<option value="Machine Learning">Machine Learning (197)</option>
