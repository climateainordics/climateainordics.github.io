...
<option value="Bayesian Optimisation">Bayesian Optimisation (25)</option>
...
<option value="Climate Impacts">Climate Impacts (65)</option>
<option value="Climate Modeling">Climate Modeling (100)</option>
...
<option value="Deep Learning">Deep Learning (154)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (123)</option>
<option value="Earth System Modeling">Earth System Modeling (43)</option>
...
<option value="Efficient or Sustainable AI">Efficient or Sustainable AI (83)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (42)</option>
...
<option value="Machine Learning">Machine Learning (185)</option>
...
<option value="Sustainable Cities">Sustainable Cities (71)</option>
...
<option value="Urban Planning">Urban Planning (48)</option>
...
<option value="Weather Forecasting">Weather Forecasting (26)</option>
