...
<option value="Deep Learning">Deep Learning (125)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (97)</option>
<option value="Earth System Modeling">Earth System Modeling (21)</option>
...
<option value="Machine Learning">Machine Learning (148)</option>
