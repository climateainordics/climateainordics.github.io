...
<option value="Computer Vision">Computer Vision (53)</option>
<option value="Deep Learning">Deep Learning (74)</option>
...
<option value="Efficient or Sustainable AI">Efficient or Sustainable AI (38)</option>
...
<option value="Machine Learning">Machine Learning (87)</option>
...
<option value="NLP">NLP (22)</option>
