...
<option value="AutoML">AutoML (5)</option>
...
<option value="Climate Modeling">Climate Modeling (63)</option>
<option value="Climate Policy">Climate Policy (1)</option>
<option value="Computer Vision">Computer Vision (72)</option>
<option value="Deep Learning">Deep Learning (98)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (75)</option>
<option value="Earth System Modeling">Earth System Modeling (6)</option>
...
<option value="Efficient or Sustainable AI">Efficient or Sustainable AI (56)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (7)</option>
...
<option value="Machine Learning">Machine Learning (115)</option>
