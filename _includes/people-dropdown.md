...
<option value="Climate Impacts">Climate Impacts (35)</option>
<option value="Climate Modeling">Climate Modeling (77)</option>
<option value="Climate Policy">Climate Policy (1)</option>
<option value="Computer Vision">Computer Vision (87)</option>
<option value="Deep Learning">Deep Learning (124)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (96)</option>
<option value="Earth System Modeling">Earth System Modeling (20)</option>
...
<option value="Machine Learning">Machine Learning (147)</option>
