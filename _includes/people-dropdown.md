...
<option value="Biodiversity">Biodiversity (100)</option>
...
<option value="Climate Impacts">Climate Impacts (94)</option>
...
<option value="Deep Learning">Deep Learning (181)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (150)</option>
<option value="Earth System Modeling">Earth System Modeling (60)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (59)</option>
...
<option value="Machine Learning">Machine Learning (214)</option>
