...
<option value="Biodiversity">Biodiversity (76)</option>
<option value="Bioinformatics">Bioinformatics (1)</option>
<option value="Causal AI">Causal AI (1)</option>
<option value="Climate Impacts">Climate Impacts (42)</option>
<option value="Climate Modeling">Climate Modeling (84)</option>
...
<option value="Deep Learning">Deep Learning (133)</option>
...
<option value="Machine Learning">Machine Learning (156)</option>
...
<option value="Urban Planning">Urban Planning (39)</option>
