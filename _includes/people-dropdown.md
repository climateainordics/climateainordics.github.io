...
<option value="Climate Impacts">Climate Impacts (93)</option>
<option value="Climate Modeling">Climate Modeling (123)</option>
<option value="Climate Policy">Climate Policy (1)</option>
<option value="Computer Vision">Computer Vision (118)</option>
...
<option value="Deep Learning">Deep Learning (180)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (149)</option>
<option value="Earth System Modeling">Earth System Modeling (59)</option>
...
<option value="Efficient or Sustainable AI">Efficient or Sustainable AI (102)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (58)</option>
...
<option value="Machine Learning">Machine Learning (213)</option>
...
<option value="Urban Planning">Urban Planning (56)</option>
