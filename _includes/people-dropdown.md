...
<option value="Biodiversity">Biodiversity (67)</option>
<option value="Bioinformatics">Bioinformatics (1)</option>
<option value="Causal AI">Causal AI (1)</option>
<option value="Climate Impacts">Climate Impacts (25)</option>
<option value="Climate Modeling">Climate Modeling (70)</option>
...
<option value="Earth Observation">Earth Observation (88)</option>
<option value="Earth System Modeling">Earth System Modeling (12)</option>
