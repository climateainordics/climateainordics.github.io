...
<option value="Extreme Weather Events">Extreme Weather Events (28)</option>
...
<option value="Machine Learning">Machine Learning (159)</option>
...
<option value="NLP">NLP (34)</option>
...
<option value="Sustainable Cities">Sustainable Cities (61)</option>
...
<option value="Sustainable Transport">Sustainable Transport (29)</option>
<option value="Uav">Uav (1)</option>
<option value="Urban Health">Urban Health (1)</option>
<option value="Urban Planning">Urban Planning (41)</option>
