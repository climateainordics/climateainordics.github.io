...
<option value="Climate Modeling">Climate Modeling (126)</option>
...
<option value="Deep Learning">Deep Learning (186)</option>
...
<option value="Earth Observation">Earth Observation (156)</option>
<option value="Earth System Modeling">Earth System Modeling (63)</option>
...
<option value="Efficient or Sustainable AI">Efficient or Sustainable AI (103)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (63)</option>
...
<option value="Machine Learning">Machine Learning (219)</option>
...
<option value="NLP">NLP (49)</option>
...
<option value="Weather Forecasting">Weather Forecasting (45)</option>
