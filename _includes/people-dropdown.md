...
<option value="Bayesian Optimisation">Bayesian Optimisation (15)</option>
...
<option value="Climate Impacts">Climate Impacts (40)</option>
<option value="Climate Modeling">Climate Modeling (82)</option>
<option value="Climate Policy">Climate Policy (1)</option>
<option value="Computer Vision">Computer Vision (89)</option>
<option value="Cryospheric Science">Cryospheric Science (1)</option>
<option value="Data Assimilation">Data Assimilation (1)</option>
<option value="Deep Learning">Deep Learning (130)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (102)</option>
<option value="Earth System Modeling">Earth System Modeling (26)</option>
...
<option value="Efficient or Sustainable AI">Efficient or Sustainable AI (71)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (25)</option>
...
<option value="Machine Learning">Machine Learning (153)</option>
...
<option value="Sustainable Energy">Sustainable Energy (14)</option>
...
<option value="Weather Forecasting">Weather Forecasting (15)</option>
