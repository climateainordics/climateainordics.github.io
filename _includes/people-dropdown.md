...
<option value="Climate Modeling">Climate Modeling (42)</option>
<option value="Climate Policy">Climate Policy (1)</option>
<option value="Computer Vision">Computer Vision (51)</option>
<option value="Deep Learning">Deep Learning (72)</option>
<option value="Earth Observation">Earth Observation (55)</option>
...
<option value="Machine Learning">Machine Learning (84)</option>
...
<option value="NLP">NLP (20)</option>
...
<option value="Urban Planning">Urban Planning (21)</option>
