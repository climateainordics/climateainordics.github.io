...
<option value="AutoML">AutoML (26)</option>
...
<option value="Biodiversity">Biodiversity (97)</option>
...
<option value="Climate Impacts">Climate Impacts (90)</option>
<option value="Climate Modeling">Climate Modeling (121)</option>
...
<option value="Deep Learning">Deep Learning (176)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (146)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (57)</option>
...
<option value="Machine Learning">Machine Learning (209)</option>
...
<option value="NLP">NLP (47)</option>
...
<option value="Urban Planning">Urban Planning (55)</option>
...
<option value="Weather Forecasting">Weather Forecasting (38)</option>
