...
<option value="Climate Impacts">Climate Impacts (20)</option>
<option value="Climate Modeling">Climate Modeling (64)</option>
<option value="Climate Policy">Climate Policy (1)</option>
<option value="Computer Vision">Computer Vision (78)</option>
<option value="Deep Learning">Deep Learning (104)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (84)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (12)</option>
...
<option value="Machine Learning">Machine Learning (124)</option>
