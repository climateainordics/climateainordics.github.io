...
<option value="Biodiversity">Biodiversity (90)</option>
...
<option value="Climate Impacts">Climate Impacts (78)</option>
...
<option value="Earth Observation">Earth Observation (137)</option>
...
<option value="Efficient or Sustainable AI">Efficient or Sustainable AI (94)</option>
...
<option value="Machine Learning">Machine Learning (202)</option>
