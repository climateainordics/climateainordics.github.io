...
<option value="AutoML">AutoML (16)</option>
...
<option value="Computer Vision">Computer Vision (107)</option>
...
<option value="Deep Learning">Deep Learning (163)</option>
...
<option value="Machine Learning">Machine Learning (193)</option>
