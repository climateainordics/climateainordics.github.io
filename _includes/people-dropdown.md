...
<option value="AutoML">AutoML (28)</option>
...
<option value="Biodiversity">Biodiversity (104)</option>
...
<option value="Climate Impacts">Climate Impacts (100)</option>
<option value="Climate Modeling">Climate Modeling (128)</option>
<option value="Climate Policy">Climate Policy (1)</option>
<option value="Computer Vision">Computer Vision (126)</option>
...
<option value="Deep Learning">Deep Learning (188)</option>
<option value="Digital Twins of The Earth">Digital Twins of The Earth (1)</option>
<option value="Digital Twins of The Ocean and Water">Digital Twins of The Ocean and Water (1)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (159)</option>
<option value="Earth System Modeling">Earth System Modeling (64)</option>
...
<option value="Efficient or Sustainable AI">Efficient or Sustainable AI (104)</option>
...
<option value="Extreme Weather Events">Extreme Weather Events (65)</option>
...
<option value="Green Landscape Planning">Green Landscape Planning (1)</option>
...
<option value="Machine Learning">Machine Learning (221)</option>
<option value="Machine Listening">Machine Listening (2)</option>
<option value="Marine Ecology">Marine Ecology (34)</option>
...
<option value="Soundscape Analysis">Soundscape Analysis (30)</option>
<option value="Spatial Analysis">Spatial Analysis (1)</option>
<option value="Spatial Modelling">Spatial Modelling (1)</option>
...
<option value="Sustainable Cities">Sustainable Cities (83)</option>
<option value="Sustainable Energy">Sustainable Energy (32)</option>
...
<option value="Sustainable Transport">Sustainable Transport (38)</option>
<option value="Time-series Analysis">Time-series Analysis (1)</option>
...
<option value="Urban Climate">Urban Climate (1)</option>
<option value="Urban Health">Urban Health (1)</option>
<option value="Urban Planning">Urban Planning (57)</option>
...
<option value="Weather Forecasting">Weather Forecasting (46)</option>
<option value="Wildfire Growth Forecasting">Wildfire Growth Forecasting (1)</option>
<option value="Wind Energy">Wind Energy (23)</option></select>
