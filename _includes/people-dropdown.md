...
<option value="Biodiversity">Biodiversity (87)</option>
...
<option value="Computer Vision">Computer Vision (106)</option>
...
<option value="Deep Learning">Deep Learning (162)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (128)</option>
...
<option value="Machine Learning">Machine Learning (192)</option>
...
<option value="NLP">NLP (41)</option>
