...
<option value="Climate Impacts">Climate Impacts (57)</option>
...
<option value="Deep Learning">Deep Learning (147)</option>
<option value="Disaster Management">Disaster Management (1)</option>
<option value="Drought">Drought (1)</option>
<option value="Earth Observation">Earth Observation (120)</option>
...
<option value="Efficient or Sustainable AI">Efficient or Sustainable AI (78)</option>
...
<option value="Machine Learning">Machine Learning (177)</option>
...
<option value="NLP">NLP (37)</option>
