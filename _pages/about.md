...
author_profile: true
image: /images/events/cain-may2025.png
...
The CAIN board (see below) plans events, collects information for and runs our webpage, takes care of our social media channels, and compiles and edits our newsletters. 

{% include board-from-form.md %}

## What are the Nordics?

Anyone active within -- or interested in -- AI for addressing climate change or environmental issues more broadly is welcome to join Climate AI Nordics. If you are affiliated with a Nordic institution you will count as a full member, but everyone is welcome! (Without such an affiliation you will be listed as a supporting member). However, the content and the events in this network will be based in the Nordic countries. And for those of you who are confused about what the Nordic countries are, we refer you to the informative Youtube video from CGP Grey discussing the Nordics, and Scandinavia.
