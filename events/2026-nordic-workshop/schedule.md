...
{% assign poster_number = poster_number | plus: 1 -%}
| {{ poster_number }}  | [John Martinsson](#john) | [A multimodal audio-video dataset for AI-based monitoring of a Baltic seabird colony under climate change](#john) |
{% assign poster_number = poster_number | plus: 1 -%}
...
{% assign poster_number = poster_number | plus: 1 %}
<a name="luca"></a>
**{{ poster_number }}. John Martinsson**, RISE<br />
