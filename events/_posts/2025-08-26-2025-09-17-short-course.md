...
image_small: /images/posts/2025-08-26-2025-09-17-short-course_small.png
people:
- Olof Mogren
- Murathan Kurfali
summary: This two-day short course introduces early-career researchers and professionals
  to how AI can be applied for processing and interpreting environmental data, with
  a focus on climate-related analysis and earth observation. Participants will learn
  core AI methods—including Large Language Models (LLMs)—and gain hands-on experience
  with practical tools through guided exercises.
